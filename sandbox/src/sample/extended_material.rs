...
pub fn text_write_global_res(req_writer: &mut MessageWriter<ReloadReq>) {
    let test_wgsl = "
#import bevy_pbr::{
...
fn fragment(
    ...
    let color2 = vec4(pbr_input.material.base_color.rgb, 0.01);
    ...
    return out;
        ...
        ";
    write_global_res(test_wgsl);

    req_writer.write(ReloadReq);
}
